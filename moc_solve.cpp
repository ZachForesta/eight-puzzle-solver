...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Solve_t, stringdata0) + ofs \
...
void Solve::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Solve::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Solve::timedout)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject Solve::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_Solve.data,
    qt_meta_data_Solve,
    qt_static_metacall,
    nullptr,
    nullptr
